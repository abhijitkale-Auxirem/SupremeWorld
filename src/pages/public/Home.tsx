...
import {
  ArrowRight, Globe, TrendingUp, BookOpen, Plane, ShoppingBag, Users,
  Star, ChevronRight, Check, Calendar, Crown, Building2, Briefcase,
  Zap, BarChart2, MessageSquare, MapPin,
} from "lucide-react";
    ...
    <PublicLayout>
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div className="absolute -top-20 -right-20 w-[400px] h-[400px] rounded-full border border-gold/8 animate-spin-slow" style={{ animationDirection: "reverse", animationDuration: "18s" }} />
          <div className="absolute top-1/4 right-1/4 w-2 h-2 rounded-full bg-gold/40 animate-float" style={{ animationDelay: "1s" }} />
          <div className="absolute top-1/3 right-1/3 w-1.5 h-1.5 rounded-full bg-gold/30 animate-float" style={{ animationDelay: "2.5s" }} />
          <div className="absolute top-2/3 right-1/5 w-1 h-1 rounded-full bg-gold/50 animate-float" style={{ animationDelay: "0.8s" }} />
        </div>
          ...
          <div className="max-w-2xl">
            ...
            <div className="animate-fade-in delay-500 flex flex-col sm:flex-row gap-4">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-white/30 text-white hover:bg-white/10 text-base px-8 transition-all duration-300"
                asChild
              >
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-royal-black/85 backdrop-blur-sm border-t border-white/10">
          <div className="container">
            <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-white/10 stagger-children">
              {STATS.map((stat) => (
                <div key={stat.label} className="py-5 px-6 text-center animate-count-up">
        ...
        <div className="container">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xs font-semibold text-gold uppercase tracking-widest">Platform</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 stagger-children">
              {PLATFORM_PAGES.map((page) => (
                ...
                >
                  <div className={`w-10 h-10 rounded-lg ${page.iconBg} flex items-center justify-center mb-3 transition-transform duration-300 group-hover:scale-110`}>
                  ...
                  <p className="text-muted-foreground text-xs leading-relaxed flex-1">{page.desc}</p>
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xs font-semibold text-deep-blue uppercase tracking-widest">Services</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 stagger-children">
              {SERVICE_PAGES.map((page) => (
                ...
                >
                  <div className={`w-12 h-12 rounded-xl ${page.iconBg} flex items-center justify-center flex-shrink-0 transition-transform duration-300 group-hover:scale-110`}>
                    <page.icon className={`w-6 h-6 ${page.iconColor}`} />
                  </div>
                  <div className="flex-1 min-w-0">
                    <h3 className="font-display font-semibold text-foreground mb-1">{page.label}</h3>
                    <p className="text-muted-foreground text-sm leading-relaxed">{page.desc}</p>
        ...
        <div className="container">
          <div className="text-center mb-14 animate-fade-in-up">
            <h2 className="font-display text-4xl font-bold text-foreground mb-4">
              One Platform. <span className="gold-text-shimmer">Infinite Possibilities.</span>
            </h2>
      ...
      <section className="py-16 bg-royal-black relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute bottom-0 right-1/4 w-64 h-64 rounded-full bg-deep-blue/5 blur-2xl animate-float" style={{ animationDelay: "2s" }} />
        </div>
        <div className="container relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { icon: Users, value: "150K+", label: "Global Members", delay: "delay-100" },
              { icon: TrendingUp, value: "$2.4B+", label: "Investments Facilitated", delay: "delay-200" },
              { icon: BarChart2, value: "4,800+", label: "Deals Closed", delay: "delay-300" },
              { icon: MapPin, value: "80+", label: "Countries", delay: "delay-400" },
            ].map((s) => (
              <div key={s.label} className={`animate-fade-in-up ${s.delay} text-center py-6 px-4 rounded-xl bg-white/5 border border-white/8 hover:border-gold/20 hover:bg-white/8 transition-all duration-300`}>
        ...
        <div className="container">
          <div className="text-center mb-14 animate-fade-in-up">
            <h2 className="font-display text-4xl font-bold text-white mb-4">
              Trusted by <span className="gold-text-shimmer">Industry Leaders</span>
            </h2>
            <p className="text-white/50 text-lg">Real results from members across 80+ countries.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="font-display text-2xl font-bold text-white mb-2">Membership Plans</h3>
                <p className="text-white/60 text-sm mb-4">Explorer to Elite — find the tier that matches your ambition.</p>
                <div className="flex items-center gap-2 text-gold text-sm font-medium">
                  View Plans <ArrowRight className="w-4 h-4 transition-transform duration-300 group-hover:translate-x-2" />
                </div>
              </div>
            </Link>
            <Link
              to={ROUTES.PRICING}
              className="group animate-fade-in-right hover-lift relative overflow-hidden p-8 rounded-2xl bg-gradient-to-br from-deep-blue/10 to-deep-blue/5 border border-deep-blue/20 hover:border-deep-blue/50 transition-all duration-300"
            >
              <div className="absolute top-0 right-0 w-32 h-32 rounded-full bg-deep-blue/10 blur-2xl transition-all duration-500 group-hover:w-48 group-hover:h-48" />
              <div className="relative z-10">
                <Zap className="w-8 h-8 text-deep-blue mb-4 transition-transform duration-300 group-hover:scale-110" />
                <h3 className="font-display text-2xl font-bold text-foreground mb-2">Pricing</h3>
                <p className="text-muted-foreground text-sm mb-4">Transparent pricing across all four membership tiers.</p>
                <div className="flex items-center gap-2 text-deep-blue text-sm font-medium">
                  See Pricing <ArrowRight className="w-4 h-4 transition-transform duration-300 group-hover:translate-x-2" />
                </div>
              </div>
            </Link>
          </div>
